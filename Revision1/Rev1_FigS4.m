...
%% Choose sigma = 1 or 3;
sigma = 1;
str1 = 'Rev1_FigS4d.csv';
str2 = 'Rev1_FigS4e.csv';
str3 = 'Rev1_FigS4f.csv';
...
[x] = ode4(@(t,x) Pools_solver_phit(t,x,xi,nu,Rt,Gamma,lambda_s,lambda_r,eta,epsilon,nmax,Phi,Phimax,sigma),t,x0);
x = x';
...
hold on
plot(T,ones(size(T)),'k--','LineWidth',1*fact_curva,'HandleVisibility','off');
hold on
