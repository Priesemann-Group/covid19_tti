...
hold on
hold on
plot(tmin:1:tmax,ones(size(tmin:1:tmax)),'r--','LineWidth',1*fact_curva,'HandleVisibility','off');
hold on
plot(tmin:1:tmax,exp(tau*mode1)*ones(size(tmin:1:tmax)),'k:','LineWidth',2*fact_curva,'HandleVisibility','off');
hold on
